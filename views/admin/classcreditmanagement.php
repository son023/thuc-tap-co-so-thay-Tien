    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-10 justify-content-center">
                ...
                <?php echo '<div><a class=" btn-get-started" href="http://localhost:3000/admin/addclasscredit" title="Sửa Thông Tin" data-toggle="tooltip" >  Thêm lớp tín chỉ </a> </div>';?>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $li) {
                            if (!is_null($li)) {
                                ...
                                echo '<td>';
                                    echo '<a class="btn-crud text-center align-middle" href="http://localhost:3000/classcre/list/'.$li->getClassCreditId().'" title="Xem lớp" data-toggle="tooltip" ><i class="fa-regular fa-eye"></i></a>';
                                    ...
                                    echo '<a class="btn-crud text-center align-middle" href="http://localhost:3000/admin/deleteclasscredit/'.$li->getClassCreditId().'" title="Xoá lớp tín chỉ" data-toggle="tooltip" ><i class="fa-solid fa-delete-left"></i></a> ';
